...
function Grid(Props) {
  ...
  var test = function (response) {
    var deviceName = Belt_Option.flatMap(response.listDogs, (function (listDogs) {
            return listDogs.items;
          }));
    var dogsOption = deviceName !== undefined ? Belt_Array.map(Belt_Array.keep(deviceName, Belt_Option.isSome), Belt_Option.getExn) : /* array */[];
    return Belt_Array.map(dogsOption, Decoder$ReasonReactExamples.makeDog);
  };
  React.useEffect((function () {
          var query = Wonka.subscribe((function (data) {
                    ...
                    if (typeof match === "number" || match.tag) {
                      ...
                      var dogsd = test(match[0]);
                      return Curry._1(dispatch, /* record */[/* payload : record */[/* dogs */dogsd]]);
                    }
